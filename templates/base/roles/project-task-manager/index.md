...
6. [Scoped history](../../shared/instructions/scoped-history.md) - History requirements when task-management work changes durable project guidance rather than task state alone.
