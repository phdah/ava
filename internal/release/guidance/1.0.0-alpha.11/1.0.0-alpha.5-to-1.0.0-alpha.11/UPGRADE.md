...
title: Upgrade Ava project context from 1.0.0-alpha.5 to 1.0.0-alpha.11
description: Reconciles project-owned knowledge organization and inbox-ingestion outcomes with Ava 1.0.0-alpha.11.
guidance_schema: 1
guidance_id: 1.0.0-alpha.5-to-1.0.0-alpha.11
...
# Upgrade Ava project context from 1.0.0-alpha.5 to 1.0.0-alpha.11
