...
title: Upgrade Ava project context from 1.0.0-alpha.6 to 1.0.0-alpha.11
description: Reconciles project-owned knowledge organization and inbox-ingestion outcomes with Ava 1.0.0-alpha.11.
guidance_schema: 1
guidance_id: 1.0.0-alpha.6-to-1.0.0-alpha.11
from_version: "1.0.0-alpha.6"
to_version: "1.0.0-alpha.11"
semantic_review_required: true
migration_ids: []
supersedes: []
generated:
  by: agent:openai-chatgpt
  at: 2026-08-08T21:40:00+02:00
---

# Upgrade Ava project context from 1.0.0-alpha.6 to 1.0.0-alpha.11

## Summary

This edge carries forward the reviewed project-owned reconciliation introduced before Ava 1.0.0-alpha.10 for knowledge hierarchy promotion and faithful inbox ingestion. Ava 1.0.0-alpha.11 also strengthens the managed root router so every request completes Ava routing before substantive handling. The router change is managed-only and requires no additional project-owned edits.
...
- `/AGENTS.md` now requires Ava routing before every substantive answer, refusal, task execution, or project action. This changes managed routing behavior only.
...
Do not edit project-owned roles, workflows, registries, metadata, or knowledge solely because `/AGENTS.md` changed.
...
Only then may compatibility advance to `1.0.0-alpha.11`.
