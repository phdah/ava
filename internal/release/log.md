...
- **Explicit source ownership**: Added separate project-scaffold and optional host-bootstrap source roots while retaining `templates/base/` as authored managed-base and format-reference source material.
- **Implementation validation**: Added focused integration coverage for installation, adoption, conflicts, unsafe archives, symlink escapes, host bootstraps, migrations, chained upgrades, semantic state, and rollback.
