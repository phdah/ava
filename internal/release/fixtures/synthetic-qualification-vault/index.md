...
This repository-only fixture generates the repeatable raw corpus used for Ava v1 qualification. The five accepted image inputs are pinned in the repository; generated vaults and qualification evidence remain outside the repository.
