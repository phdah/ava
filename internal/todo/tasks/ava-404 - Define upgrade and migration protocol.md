---
id: ava-404
title: "Define the upgrade and migration protocol"
status: "Done"
...
Define safe base reconciliation, deterministic migrations, conflicts, rollback, and separate semantic completion state. The complete pre-Backlog task record is preserved below.
...
Validation covered idle and active upgrade journal states, rejection of normal routing in active upgrade state, direct/chained edge constraints, migration descriptors, an explicit MAJOR transition with semantic review, and rejection of a non-idempotent migration descriptor.
