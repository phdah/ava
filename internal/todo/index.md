...
- OpenCode is the first host Ava must support through a maintained conformance fixture and documented configuration.
...
1. [Format contract and base structure](01-format-contract/) - 3 of 4 complete; document update metadata is a v1 blocker
...
4. [Versioned distribution and upgrades](04-distribution-and-upgrades/) - 7 of 10 complete; active with installed path normalization next
...
1. normalize installed project paths
2. implement and prove OpenCode support while settling managed-directory discoverability
3. complete document update metadata
4. create the Ava Maintenance role
5. implement the full validation, conformance, and upgrade matrix
6. define alpha acceptance and prerelease upgrade policy
7. publish `1.0.0-alpha.1`
8. dogfood the alpha and add bounded fix tasks for discovered defects
9. publish a release candidate only after alpha blockers are resolved
10. qualify and publish `1.0.0`
