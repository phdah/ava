---
id: ava-405
title: "Define release guidance and the Upgrade Role"
status: "Done"
...
Define structured release information and an explicit Upgrade Role for one-prompt semantic reconciliation. The complete pre-Backlog task record is preserved below.
...
Validation covered JSON parsing/schema shape, all five mandatory Upgrade Role files and required-reading links, direct managed activation, normal-routing blocks, managed versus project-owned mutation boundaries, one-prompt scope restrictions, guidance metadata/sections/composition/decisions/completion/rollback rules, workflow registry wording, and roadmap handoff.
