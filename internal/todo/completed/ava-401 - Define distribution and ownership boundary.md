---
id: ava-401
title: "Define the distribution and ownership boundary"
status: "Done"
...
Define Ava as a file distribution and separate Ava-managed base content from project-owned context. This task also preserves the Phase 04 roadmap context.
...
The contract covers exact installed ownership paths, separation between distribution ownership and role mutation authority, router and extension discovery, manifest authority, managed-file conflict detection, fresh installation eligibility, existing-project adoption and collision behavior, unversioned Ava migration, discovery outcomes, and repository-source to installed-path mapping.

The incompatible public path decision was approved by the user before implementation.

## Migrated phase roadmap context

Phase 04 defined and implemented Ava as an immutable, versioned context distribution installed and upgraded through thin release tooling. Its ten completed tasks cover ownership, SemVer and compatibility, GitHub release assets, upgrade protocol, release guidance and Upgrade Role, repository boundaries, installer/updater, installed path normalization, OpenCode support, and validation/conformance fixtures.

Phase 4 is complete. Release tooling, installed-state maintenance, OpenCode support, semantic upgrade separation, and conformance qualification were ready for prerelease policy and alpha publication.