...
Keep Ava-managed context hidden while installing a minimal project-owned OpenCode permission configuration by default. The complete pre-Backlog task record is preserved below.
...
The focused suite verifies default configuration creation, `--host none`, preservation of existing OpenCode configuration, manual merge guidance, and upgrade preservation of project-owned host configuration.
