...
Ensure each qualification run inventories only OpenCode sessions created for that exact run and cannot absorb historical qualification sessions. This native Backlog.md task contains the complete pre-Backlog task record.
