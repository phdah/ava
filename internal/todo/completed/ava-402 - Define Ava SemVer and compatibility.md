---
id: ava-402
title: "Define the Ava SemVer and compatibility contract"
status: "Done"
...
Define installed-base versioning and separate semantic compatibility for project-owned context. The complete pre-Backlog task record is preserved below.
...
The schema was parsed with `python -m json.tool` and validated with `jsonschema` against a valid pending semantic migration, a valid complete semantic migration, and rejection of checksums on mutable state entries.
