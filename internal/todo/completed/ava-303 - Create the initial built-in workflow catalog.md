...
Create the initial built-in workflow catalog. The complete pre-Backlog task record is preserved below.
...
Scheduling and execution remain outside Ava's runtime and were deferred to trigger portability.
