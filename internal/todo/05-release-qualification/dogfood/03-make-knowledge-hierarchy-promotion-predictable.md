...
- IntegrationA and IntegrationB describe durable external data interfaces but are typed and filed as meeting notes beneath projects
- InitiativeA and InitiativeB represent initiatives or projects but use meeting-note or project-note types
- ProjectA, ProjectB, and ProjectC require a project-owned decision about whether their stable identities are projects, integrations, systems, or independently useful meeting records
